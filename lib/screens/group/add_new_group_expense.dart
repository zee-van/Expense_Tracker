...
import 'package:expense_tracker/providers/add_group_expense_provider.dart';
...
class AddNewGroupExpense extends ConsumerStatefulWidget {
  const AddNewGroupExpense({super.key, this.groupId});
  final String? groupId;

  @override
  ConsumerState<AddNewGroupExpense> createState() => _AddNewGroupExpenseState();
}

class _AddNewGroupExpenseState extends ConsumerState<AddNewGroupExpense> {
  ...
  Future<void> _addGrouplExpense() async {
    final isValid = _form.currentState!.validate();
    if (isValid) {
      _form.currentState!.save();
      try {
        final groupExpense = GroupExpenseData(
        ...
        await ref
            .watch(addGroupExpenseProvider.notifier)
